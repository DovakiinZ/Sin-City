          ...
          <div className="flex items-center justify-center flex-shrink-0">
            <img
              ...
              className={isMobileDevice
                ? "w-16 h-16 object-contain opacity-90 hover:opacity-100 transition-opacity duration-300"
                : "w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 object-contain opacity-90 hover:opacity-100 transition-opacity duration-300"
              }
            />
          </div>
        </div>
