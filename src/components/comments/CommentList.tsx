...
export default function CommentList({ postId, postAuthorId }: CommentListProps) {
    ...
    if (!user) {
        return (
            <div className="mt-8 text-center p-6 bg-black/30 border border-green-900/30 rounded-lg">
                <p className="text-gray-500 text-sm">
                    <a href="/login" className="text-green-400 hover:underline">Sign in</a> to view comments
                </p>
            </div>
        );
    }
