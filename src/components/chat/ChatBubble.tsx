    ...
    return (
        <>
            ...
            >
                ...
                {/* Bubble */}
                <div className={cn(
                    "relative rounded-[10px] px-[12px] py-[10px] font-mono",
                    "border transition-all",
                    isSent
                        ? "bg-[#0f2a1f] border-[#00ff88]"
                        : "bg-[#111111] border-[#1f1f1f]"
                )}>
                    {/* Sender name (for received messages) */}
                    {!isSent && (
                        <div className="text-[#00ff88] mb-1 font-medium" style={{ fontSize: '11px' }}>
                    ...
                    {/* Media content */}
                    {(mediaUrl || gifUrl) && (
                        <div className="mb-1 rounded-lg overflow-hidden max-h-40 cursor-pointer"
                    ...
                    {/* Voice message */}
                    {voiceUrl && (
                        <div className="flex items-center gap-2 mb-1 bg-black/30 rounded-full px-3 py-1.5">
                            <button
                                onClick={toggleAudio}
                    ...
                    {!!displayContent && displayContent.trim() !== "" && (
                        <div
                            ...
                            className={`whitespace-pre-wrap break-words leading-relaxed text-[#ffffff] ${contentIsArabic ? 'arabic-text text-right' : 'text-left'}`}
                            style={{
                                fontSize: '15px',
                    ...
                    <div className={cn(
                        ...
                        <span className="text-[#666666]" style={{ fontSize: '10px' }}>{formatTime(timestamp)}</span>
                        {isSent && status && (
