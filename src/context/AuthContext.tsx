...
interface AuthContextType {
  ...
  mfa: {
    enroll: (friendlyName?: string) => Promise<{ id: string; type: 'totp'; totp: { qr_code: string; secret: string; uri: string } }>;
...
function mapSupabaseUser(u: SupabaseAuthUser | null): User | null {
  ...
  const role = (u.user_metadata?.role as string | undefined) || undefined;
